...
const base=(process.argv[2]||process.env.SMOKE_BASE_URL||"http://127.0.0.1:4173").replace(/\/$/,"");
const routes=["/","/admin/","/login/","/account/","/services/","/packages/","/reviews/","/team/","/hair-systems/","/results/","/branches/talkha/","/branches/mashaya/","/firebase-config.js","/favicon.ico","/assets/icon-192.png"];
