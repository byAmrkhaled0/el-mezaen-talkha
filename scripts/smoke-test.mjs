...
const routes=["/","/admin/","/login/","/account/","/services/","/team/","/hair-systems/","/results/","/branches/talkha/","/branches/mashaya/","/firebase-config.js","/favicon.ico","/assets/icon-192.png"];
